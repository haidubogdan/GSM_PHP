...
class Home extends Base
{
    ...
    {
        $data["title"] = "GSM creater";
        $this->render("app/views/layout/head_view.php", $data);
        echo "BUNA";
        //system("cmd /c C:\xml_converter_to_gsm_18_to_library.bat");
        $path = '""C:\Program Files\GRAPHISOFT\ArchiCAD 18\LP_XMLConverter.exe" x2l "D:\Odesk\GSM_from_xml\xml_library" "C:\Users\Bogdan\Graphisoft\ArchiCAD AutoSave Folder-3\Emb_0""';
    ...
    function openXmlFile($file,$data)
    {
    ...
    function start3dScript($Script3D)
    {
        ...
        $Script3D->operation("add", "x_rama-offset_pliere,0,x_profil_usa+sill*(x_rama - 0.02)");
        $Script3D->addToExpression('GOSUB "pliere"');
        $Script3D->addDeleteAll();
        $Script3D->addToExpression('END');
        var_dump($Script3D->countModification);
    }
